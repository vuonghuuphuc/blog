...
$(document).ready(function () {
  ...
  fromNow = function fromNow(data) {
    return moment.utc(data).local().fromNow();
  };

  dateFormat = function dateFormat(data) {
  ...
  $.fn.extend({
    toValidateForm: function toValidateForm() {
    ...
    toAjaxForm: function toAjaxForm(options) {
      options = options || {};
      return this.each(function () {
        var $form = $(this);
          ...
          if (responseJson.message || responseJson.errors) {
            ...
            if (responseJson.errors) {
              for (var inputName in responseJson.errors) {
                ...
                if ($input) {
                  var message = responseJson.errors[inputName][0];
                  $input.removeClass("valid").addClass("invalid");
                  $input.parent().append($("<span/>").addClass("help-block invalid-feedback").text(message));
                  $input.focus();
                }
              }
            }
    ...
    toAjaxAndValidateForm: function toAjaxAndValidateForm(options) {
      return this.each(function () {
        $(this).toValidateForm();
...
__webpack_require__(/*! C:\Users\Phuc\Projects\blog\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! C:\Users\Phuc\Projects\blog\resources\sass\app.scss */"./resources/sass/app.scss");
